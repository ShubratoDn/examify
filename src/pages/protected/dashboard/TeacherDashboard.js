...
import { faAdd, faEnvelope, faGear, faHome, faRightFromBracket } from '@fortawesome/free-solid-svg-icons'
...
function TeacherDashboard({title, children}) {
            ...
            <div className="nav-left">
                <div className="nav-left-user d-flex align-items-center px-3">
                    ...
                    <div className='d-flex flex-column'>
                        ...
                        <span className='text-muted font-12 align-right d-block'>(Teacher)</span>
                ...
                <ul className='navbar-nav'>
                    <li className='nav-item'><NavLink to={"/teacher/dashboard"} className='nav-link'><FontAwesomeIcon icon={faHome} className='nav-icon' /> <span>Home</span></NavLink></li>
                    <li className='nav-item'><NavLink to={"/teacher/add-exam"} className='nav-link'><FontAwesomeIcon icon={faAdd} className='nav-icon' /> <span>Add Exam</span></NavLink></li>
                    <li className='nav-item'><NavLink to={"/"} className='nav-link'><FontAwesomeIcon icon={faNewspaper} className='nav-icon' /> <span>Check Notes</span></NavLink></li>
                    <li className='nav-item'><NavLink to={"/"} className='nav-link'><FontAwesomeIcon icon={faGear} className='nav-icon'/> <span>Settings</span></NavLink></li>
                    <li className='nav-item'><NavLink to={"/logout"} className='nav-link'><FontAwesomeIcon icon={faRightFromBracket} className='nav-icon' /><span>Logout</span></NavLink></li>
                </ul>
